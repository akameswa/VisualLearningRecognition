...
class Encoder(nn.Module):
    ...
    def __init__(self, input_shape, latent_dim):
        ...
        self.fc = nn.Linear(256 * (input_shape[1] // 8) * (input_shape[2] // 8), latent_dim)
        ##################################################################
        #                          END OF YOUR CODE                      #
        ##################################################################
    ...
    def forward(self, x):
        ##################################################################
        # TODO 2.1: Forward pass through the network, output should bes
...
class VAEEncoder(Encoder):
    def __init__(self, input_shape, latent_dim):
        ...
        # 2*self.latent_dim
        ##################################################################
        self.fc = nn.Linear(256 * (input_shape[1] // 8) * (input_shape[2] // 8), 2 * latent_dim)
        ##################################################################
        #                          END OF YOUR CODE                      #
        ##################################################################
...
class Decoder(nn.Module):
    ...
    def forward(self, z):
        ...
        ##################################################################
        z = self.fc(z)
        z = z.reshape(z.size(0), 256, (self.output_shape[1] // 8), (self.output_shape[2] // 8))
        z = self.deconvs(z)
        return z
        ##################################################################
        #                          END OF YOUR CODE                      #
